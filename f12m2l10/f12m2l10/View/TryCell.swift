...
class TryCell: UICollectionViewCell {
	...
	static let cellId = "TryCell"
	
	private lazy var previewView: UIImageView = {
		$0.translatesAutoresizingMaskIntoConstraints = false
		$0.widthAnchor.constraint(equalToConstant: contentView.bounds.width).isActive = true
		$0.heightAnchor.constraint(equalToConstant: contentView.bounds.height).isActive = true
